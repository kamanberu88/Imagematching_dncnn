...
truepoint_path = img1_path + "true_point.csv"
...
f3 = open("s_Matchingre" + str(noise) + ".csv", "w")
...
model_path = './save_model/dncnn18.pth'
...
model.eval()
with open('./dncnn122_matching400.csv','w',newline="") as f:
        writer = csv.writer(f)
        writer.writerow(['dncnn_match','dncnn_inlier','kyori'])
...
for l in tqdm(range(len(data))):
    ...
    #save_path = f"./gazoo2/400/output_{l+1}.jpg"
    ...
    phase = "RatioTest"
    label1 = phase
    c1_pt, c_f, m_pt, m_f = matchRatio(c_pt, cf, mpt, mf, knn, ratio)
    #print(c_pt)  #list
    #print(c_f) #list
    #print(m_pt)  #list
    #print(m_f)   #list
    ...
    f3.write("\n" + str(d) + "," )
    with open('./dncnn122_matching407.csv','a',newline="") as fa:
